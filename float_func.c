...
/* apply a C function to each value in a raw "float" input file                -James Holton               10-6-16
...
typedef enum { UNKNOWN, SQRT, CBRT, CEIL, FLOOR, FABS,
       ...
       REVERSE, STRIDE, STITCH, FLIP, FLOP, FLIPFLOP } func_name;
